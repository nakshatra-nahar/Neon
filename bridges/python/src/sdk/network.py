...
from ..constants import neon_VERSION, PYTHON_BRIDGE_VERSION
...
class Network:
    ...
    def request(self, options: NetworkRequestOptions) -> NetworkResponse:
        try:
            ...
            response = requests.request(
                ...
                json=data,
                headers={
                    'User-Agent': f"neon Personal Assistant {neon_VERSION} - Python Bridge {PYTHON_BRIDGE_VERSION}",
                    **headers
                }
            )
    ...
    def is_network_available(self) -> bool:
        try:
            socket.gethostbyname('getneon.ai')
